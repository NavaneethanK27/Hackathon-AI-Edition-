    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {/* Due date */}
          <div className="space-y-1">
            <label htmlFor="task-due-date" className="text-xs font-semibold text-slate-600 dark:text-slate-350">Due Date deadline</label>
            <div className="relative">
              <input
                ...
                autoComplete="off"
                className="relative z-10 w-full glass-input pl-10"
              />

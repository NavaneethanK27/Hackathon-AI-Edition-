          ...
          <form onSubmit={handleManualAddBlock} className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                  <label htmlFor="study-block-date" className="text-xs font-semibold text-slate-600 dark:text-slate-350">Date</label>
                  <input
                    id="study-block-date"
                    type="date"
                    required
                    ...
                    autoComplete="off"
                    className="relative z-10 w-full glass-input"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg border text-xs font-bold transition-all ${!isBreak

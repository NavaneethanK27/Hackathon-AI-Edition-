          ...
          <div className="glass-card p-4 space-y-2">
            ...
            <nav className="flex flex-col gap-1.5">
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-xs font-bold flex items-center gap-2.5 transition-all ${activeTab === 'chat'
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-xs font-bold flex items-center gap-2.5 transition-all ${activeTab === 'burnout'
                    ? 'bg-brand-600 text-white shadow-md shadow-brand-600/15'
                    : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-900/60'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-xs font-bold flex items-center gap-2.5 transition-all ${activeTab === 'optimize'
                    ? 'bg-brand-600 text-white shadow-md shadow-brand-600/15'
                    : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-900/60'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-xs font-bold flex items-center gap-2.5 transition-all ${activeTab === 'insights'
                    ? 'bg-brand-600 text-white shadow-md shadow-brand-600/15'
                    : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-900/60'
                  }`}
              >
        ...
        <div className="lg:col-span-9">
          ...
          {activeTab === 'chat' && (
            <div className="glass-card flex flex-col h-[650px] relative overflow-hidden">
              ...
              {error && (
                <div className="px-5 py-3 border-b border-rose-500/20 bg-rose-500/10 text-rose-700 dark:text-rose-200 text-xs font-semibold">
                  {error}
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-center bg-slate-50 dark:bg-slate-900/30 p-5 rounded-2xl border border-slate-200/50 dark:border-slate-800/40">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className={`text-xs font-black uppercase flex items-center gap-1.5 ${burnoutData.level === 'critical' ? 'text-rose-500' :
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-800 rounded-full h-3 relative">
                      <div
                        className={`h-3 rounded-full transition-all duration-500 ${burnoutData.level === 'critical' ? 'bg-gradient-to-r from-orange-500 to-rose-600' :
                      ...
                      <div className="grid gap-2.5 max-h-[300px] overflow-y-auto pr-1">
                        {optimizeResult.blocks.slice(0, 6).map((blk, idx) => (
                          <div key={idx} className="flex items-center justify-between p-3.5 bg-white dark:bg-[#121624]/60 border border-slate-200/50 dark:border-slate-800/40 rounded-xl">
                            ...
                            <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${blk.isBreak ? 'bg-indigo-500/10 text-indigo-500 border border-indigo-500/10' : 'bg-brand-500/10 text-brand-500 border border-brand-500/10'
                              }`}>

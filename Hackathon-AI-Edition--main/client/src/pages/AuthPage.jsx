          ...
          {!isLogin && (
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-violet-500/20 to-indigo-500/20 opacity-0 group-focus-within:opacity-100 blur transition duration-300 pointer-events-none" />
